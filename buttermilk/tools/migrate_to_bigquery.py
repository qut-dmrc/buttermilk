...
from buttermilk.data.loaders import create_data_loader, DataSourceConfig


class DatasetMigrator:
    """Handles migration of datasets from various sources to BigQuery Records tables."""
    
    def __init__(self, project_id: str, dataset_id: str = "buttermilk", table_id: str = "records"):
...
def migrate_jsonl(source: str, dataset_name: str, project_id: str, split_type: str, 
...
def create_mapping(source: str, output: str | None):
    ...
    migrator = DatasetMigrator("dummy")  # Project ID not needed for this operation
...
def test_load(project_id: str, dataset_name: str, limit: int):

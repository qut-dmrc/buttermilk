...
=======
        self.app_error_regexes = [
            re.compile(pattern, re.IGNORECASE)
            for pattern in self.APPLICATION_ERROR_PATTERNS
        ]
        self.infra_error_regexes = [
            re.compile(pattern, re.IGNORECASE)
...
=======
    logging.getLogger("autogen_core._single_threaded_agent_runtime").setLevel(
        logging.ERROR
    )
>>>>>>> origin/stable
...
<<<<<<< HEAD
    logging.getLogger("weave.integrations.autogen.autogen_sdk").setLevel(logging.CRITICAL)
=======
    logging.getLogger("weave.integrations.autogen.autogen_sdk").setLevel(
        logging.CRITICAL
    )
>>>>>>> origin/stable
...
=======
        logger.setLevel(
            logging.WARNING
        )  # Allow warnings and errors, but filter selectively
>>>>>>> origin/stable

...
const FALLBACK_RECORDS = {
  ...
  "user-authentication": [
    ...
    { id: "auth-2", name: "Failed Attempts", description: "Number of failed login attempts" },
    {
      ...
      description: "Number of accounts locked due to failed attempts",
    },
  ...
  "content-moderation": [
    {
      ...
      description: "Content flagged as potentially violating guidelines",
    },
    {
      id: "mod-2",
      name: "Removed Posts",
      description: "Posts that were removed for violating guidelines",
    },
    { id: "mod-3", name: "User Reports", description: "Reports submitted by users about content" },
    {
      id: "mod-4",
      name: "False Positives",
      description: "Content incorrectly flagged as violating",
    },
  ],
  "data-extraction": [
    { id: "extract-1", name: "Documents Processed", description: "Number of documents processed" },
    {
      ...
      description: "Accuracy rate of data extraction",
    },
  ...
  "sentiment-analysis": [
    ...
    { id: "sent-3", name: "Neutral Sentiment", description: "Content with neutral sentiment" },
    {
      ...
      description: "Average confidence score of sentiment analysis",
    },
  ],
  "entity-recognition": [

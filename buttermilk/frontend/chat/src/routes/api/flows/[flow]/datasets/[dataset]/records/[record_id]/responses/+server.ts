    ...
    responses: [
      {
        ...
        score: 0.92,
        reasoning:
          "The content uses derogatory terms and promotes harmful stereotypes about transgender people. Despite being from a satirical source, the language employed can contribute to discrimination and harassment.",
      ...
      },
      {
        ...
        score: 0.89,
        reasoning:
          "Analysis reveals multiple markers of transphobic content including misgendering, use of slurs, and promotion of discriminatory attitudes. The satirical context does not mitigate the harmful impact.",
        criteria_used: "trans_advocacy",
        template: "trans_judge_v1",
      ...
      },
      {
        ...
        score: 0.91,
        reasoning:
          "Multiple evaluation perspectives align on the harmful nature of this content. The consistency across different models and criteria indicates high confidence in the violation assessment.",
        criteria_used: "trans_advocacy",

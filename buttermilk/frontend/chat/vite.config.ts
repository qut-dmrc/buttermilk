...
export default defineConfig(({ mode }) => {
	...
	return {
		...
		server: {
			...
			allowedHosts: [
				'localhost',
				'nichome.stoat-musical.ts.net',
				'services.stoat-musical.ts.net',
				'nichome',
				'wsl',
				'services',
				'nicdev',
				'nicdev.stoat-musical.ts.net',
				'127.0.0.1'
			],
		...
		optimizeDeps: {
			include: ['@sveltejs/kit', 'bootstrap', 'bootstrap/dist/js/bootstrap.bundle.min.js'],
			exclude: []
		},

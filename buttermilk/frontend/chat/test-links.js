...
function testMessageWithLinks() {
	...
	console.log(
		'In this paper (doi:10.1038/nature09410), the authors demonstrate a novel approach. You can also check their website at https://research-lab.example.edu for more information. Another related study is available at 10.1093/nar/gkaa942.'
	);
	...
	console.log(
		'- Log entry with both: [INFO] User accessed https://api.example.org and requested document doi:10.1038/nature09410'
	);
}

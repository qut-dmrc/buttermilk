...
export interface AgentMessage extends Message {
  type: "agent_input" | "agent_output" | "agent_trace" | "step_request" | "conductor_request" | "tool_output"
  agent_id?: string
  session_id?: string
  trace_id?: string
}
...
export const isAgentMessage = (msg: Message): msg is AgentMessage => {
  return ["agent_input", "agent_output", "agent_trace", "step_request", "conductor_request", "tool_output"].includes(
    msg.type,
  )
}

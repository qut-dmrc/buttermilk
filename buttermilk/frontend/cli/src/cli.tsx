...
const BACKEND_PORT = cli.flags.url && cli.flags.url !== ""
  ? parseInt(new URL(cli.flags.url).port || "80")
  : cli.flags.port
const BACKEND_PROTOCOL = cli.flags.url && cli.flags.url !== ""
  ? new URL(cli.flags.url).protocol.replace(":", "")
  : "http"

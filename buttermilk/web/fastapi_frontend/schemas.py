...
class ScoreData(BaseModel):
    ...
    assessments: Optional[List[Assessment]] = Field(None, description="List of assessments")
...
class PredictionData(BaseModel):
    ...
    reasons: Optional[List[str]] = Field(None, description="Reasons for the prediction")


class ProgressData(BaseModel):
    """Progress data model"""
    role: Optional[str] = Field(None, description="Role associated with the progress")
    ...
    pending_agents: Optional[List[str]] = Field(None, description="List of pending agents")
...
class ChatMessage(BaseModel):
    ...
    agent_info: Optional[AgentInfo] = Field(None, description="Information about the agent")
...
class RunFlowRequest(BaseModel):
    ...
    criteria: Optional[str] = Field(None, description="Criteria to use for evaluation")
...
class SessionData(BaseModel):
    ...
    callback: Optional[Any] = Field(None, description="Callback function for the session")
    outcomes_version: Optional[str] = Field(None, description="Version of the outcomes")

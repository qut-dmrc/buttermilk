...
import asyncio
from typing import Any, Self, Type # For type hinting
...
class RagZot(LLMAgent, ToolConfig):
    ...
    def _load_tools(self) -> Self:
        ...
        search_tool = FunctionTool(
            ...
            func=self._run, # Points to the method that executes the search
    ...
    async def _run(self, queries: list[str]) -> list[ToolOutput]: # This is the tool's callable method

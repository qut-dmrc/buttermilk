    ...
    async def _process(
        ...
        **kwargs: Any,  # Additional kwargs for flexibility
        ...
        Args:
            ...
            **kwargs: Additional keyword arguments, including optional 'cancellation_token'.

        Returns:
            AgentOutput | None:
            - `AgentOutput` containing the LLM's response or structured output.
            - `None` if the message type is ignored or if processing is skipped.

        Raises:
            ProcessingError: If there's no usable content in the message or if
                the Autogen agent encounters an error during processing.
        ...
        # Construct and return AgentOutput
        # The 'call_id' for AgentOutput will be generated by its default factory.
        return AgentOutput(

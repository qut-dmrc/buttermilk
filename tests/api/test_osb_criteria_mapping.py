...
async def test_non_osb_flow_criteria_unchanged():
    ...
    frontend_message = {"type": "run_flow", "flow": "some_other_flow", "record_id": "test-record-456", "criteria": "Some criteria text"}
...
async def test_osb_flow_with_empty_criteria():
    ...
    frontend_message = {"type": "run_flow", "flow": "osb", "record_id": "test-record-789", "criteria": ""}
...
async def test_osb_flow_with_direct_query():
    ...
    frontend_message = {"type": "run_flow", "flow": "osb", "record_id": "test-record-999", "query": "Direct query text"}

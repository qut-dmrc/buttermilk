...
class TestExecutionTrace:
    ...
    def test_execution_trace_creation(self):
        ...
        with patch("buttermilk._core.contract.bm", MagicMock()):
    ...
    def test_execution_trace_with_messages(self):
    ...
    def test_execution_trace_with_error(self):
    ...
    def test_execution_trace_no_error(self):
    ...
    def test_execution_trace_from_output(self):
    ...
    def test_execution_trace_with_record(self):
    ...
    def test_execution_trace_model_dump(self):
        """Test ExecutionTrace serialization for BigQuery."""
        with patch("buttermilk._core.contract.bm") as mock_bm:
            mock_bm.session_info.session_id = "mock_session_id"
            trace = ExecutionTrace(
...
class TestTraceWriter:
    ...
    @pytest.mark.asyncio
    async def test_trace_writer_singleton(self):
        """Test TraceWriter is a singleton."""
        with patch("buttermilk.utils.trace_writer.bm", MagicMock()):
            writer1 = TraceWriter()
            writer2 = TraceWriter()
    ...
    @pytest.mark.asyncio
    async def test_trace_writer_add(self):
    ...
    @pytest.mark.asyncio
    async def test_trace_writer_no_config(self):

...
- `tests/groupchat/test_agenttrace_runinfo.py`
  - Test: `test_agenttrace_serializes_runinfo_correctly
...
- `tests/examples/test_standalone_trace_examples.py`
  - Test: `TestStandaloneTraceExamples::test_batch_processing_pattern
...
- `tests/groupchat/test_llm_wrapper.py`
  - Test: `test_create_schema_with_base_model_content_normalizes_and_parses

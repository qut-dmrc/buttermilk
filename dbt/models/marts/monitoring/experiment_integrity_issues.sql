{{
  config(
    materialized='table',
    description='Experiment integrity issues for monitoring dashboard'
  )
}}

-- Monitor experimental integrity: ensure proper A/B test structure and golden set coverage
-- Returns rows when experiments have structural problems or insufficient coverage

{{
  config(
    materialized='table',
    description='Data sufficiency issues for monitoring dashboard'
  )
}}

-- Monitor data sufficiency for meaningful analysis
-- Returns rows when data sufficiency is questionable

...
2. Batch similar errors (e.g., all F821 for same class)
3. Use ruff --fix for trivial issues, focus on real problems
4. Skip entire files if core dependency removed

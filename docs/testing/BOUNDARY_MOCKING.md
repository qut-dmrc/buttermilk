...
2. **Use appropriate tools** - respx for HTTP, freezegun for time, etc.
3. **Keep mocks simple** - Complex mock setups indicate design problems
4. **Prefer test doubles over mocks** for complex external systems
5. **Never mock your own code** - Only mock external dependencies
